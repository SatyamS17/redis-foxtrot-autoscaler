...
# Builds operator, deploys it, applies cluster manifest, and tails logs
...
echo "=============================================================="
echo " Building and Deploying Redis Operator (no Docker required)"
echo "=============================================================="
...
echo "--- [2/5] Running make commands ---"
make install
make vendor
make manifests

# --- Step 3: Deploy Operator ---
echo "--- [3/5] Deploying operator ---"
make deploy
